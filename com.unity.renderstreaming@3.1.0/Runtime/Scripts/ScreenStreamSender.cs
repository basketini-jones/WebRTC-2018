    ...
    public class ScreenStreamSender : VideoStreamSender
    {
        ...
        protected override MediaStreamTrack CreateTrack()
        {
            ...
            if (m_sendTexture != null)
            {
                ...
                GraphicsFormatUtility.GetGraphicsFormat(supportFormat, true);
                GraphicsFormat compatibleFormat = GraphicsFormat.RGB_BC6H_UFloat;
            ...
            return new VideoStreamTrack(rt.GetNativeTexturePtr(), rt.width, rt.height, GraphicsFormat.RGB_BC6H_UFloat);
        }
